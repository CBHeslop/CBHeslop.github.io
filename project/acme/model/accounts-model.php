...
// Handles Site Registrations
    ...
    function regClient($clientFirstname, $clientLastname, $clientEmail, $clientPassword) {
        ...
        $db = acmeConnect();
        // The SQL statement
        $sql = 'INSERT INTO clients (clientFirstname, clientLastname,clientEmail, clientPassword, comments)
            VALUES (:clientFirstname, :clientLastname, :clientEmail, :clientPassword, :comments)';
        ...
        $stmt->bindValue(':comments', '', PDO::PARAM_STR);
        // Insert the data
        $stmt->execute();
    ...
    function getClient($clientEmail){
        ...
        $sql = 'SELECT clientId, clientFirstname, clientLastname, clientEmail, 
                clientLevel, clientPassword FROM clients WHERE clientEmail = :clientEmail';
        // Create the prepared statement using the acme connection
        $stmt = $db->prepare($sql);
        // The next four lines replace the placeholders in the SQL
        // statement with the actual values in the variables
